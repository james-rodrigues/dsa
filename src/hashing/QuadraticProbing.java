...
public class QuadraticProbing {
	...
	/** The no of cells used in hash table. */
	int noOfCellsUsedInHashTable;

	/**
	 * Instantiates a new quadratic probing.
	 */
	// Contructor
	QuadraticProbing() {
	 ...
	 * Rehash keys.
	 *
	 * @param newStringToBeInserted the new string to be inserted
	 */
